...
from PySide6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QPushButton, 
                               ...
                               QMessageBox, QInputDialog, QGroupBox, QFrame, QGridLayout)
...
def setup_ui(controller):
    ...
    controller.image_label.setStyleSheet("border: 2px solid gray; background-color: black;")
    ...
    controller.setLayout(main_layout)
